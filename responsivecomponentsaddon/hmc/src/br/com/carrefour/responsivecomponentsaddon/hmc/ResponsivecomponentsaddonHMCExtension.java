 ...
 *
 */
package br.com.carrefour.responsivecomponentsaddon.hmc;
...
/**
 * Provides necessary meta information about the responsivecomponentsaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.2
 */
public class ResponsivecomponentsaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ResponsivecomponentsaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "br.com.carrefour.responsivecomponentsaddon.hmc.locales";
