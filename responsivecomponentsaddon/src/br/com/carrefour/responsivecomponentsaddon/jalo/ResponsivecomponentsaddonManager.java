 ...
 *
 */
package br.com.carrefour.responsivecomponentsaddon.jalo;
...
import br.com.carrefour.responsivecomponentsaddon.constants.ResponsivecomponentsaddonConstants;



/**
 * This is the extension manager of the Responsivecomponentsaddon extension.
 */
public class ResponsivecomponentsaddonManager extends GeneratedResponsivecomponentsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ResponsivecomponentsaddonManager.class.getName());
	 ...
	 */
	public static ResponsivecomponentsaddonManager getInstance()
	{
		return (ResponsivecomponentsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ResponsivecomponentsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ResponsivecomponentsaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ResponsivecomponentsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ResponsivecomponentsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ResponsivecomponentsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
